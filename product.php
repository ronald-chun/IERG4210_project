    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="content col-md-10 col-sm-10">
                ...
                <!-- Shopping Cart -->
                <div class="row">
                    <nav class="nav-bar col-md-8 col-sm-8"><a href="..">Home</a> > <?php echo "<a href='category.php?catid=" . $catId ."'>"; echo $catName ?> </a> > <?php echo "<a href='product.php?catid=" . $catId . "&pid=" . $prodId . "'>"; echo $prodName ?> </a></nav>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <article>
                            <section>
                                ...
                                <?php echo "<button  type='button' class='add btn btn-default' data-pid='" . $prodId . "'>Add</button>"; ?>
                            </section>
